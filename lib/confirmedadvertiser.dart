...
//
// class confirmedadvertsers extends StatefulWidget {
//   final adv ads;
//   confirmedadvertsers(this.ads);
//   @override
//   _confirmedadvertsersState createState() => _confirmedadvertsersState();
// }
//
// class _confirmedadvertsersState extends State<confirmedadvertsers> {
...
//               onTap: () async{
//                 dynamic result= await Navigator.push(context, MaterialPageRoute(builder: (context)=>content(widget.ads, l[index].advertiserid)));
//                 if(result=='back'){
...
class confirmedadvertsers extends StatefulWidget {
  ...
  confirmedadvertsers(this.ads);
  @override
  confirmedadvertsersState createState() => new confirmedadvertsersState();
}

class confirmedadvertsersState extends State<confirmedadvertsers> {
  final _applyy = FirebaseDatabase.instance.reference().child('apply');
  final _adv = FirebaseDatabase.instance.reference().child('advertisers');
  List<dynamic> l = [];
  List<dynamic> l2 = [];
