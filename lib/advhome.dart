                            ...
                            itemBuilder: (context,index){
                              ...
                              return AdvHomeCard(
                                ...
                                press1: () async {
                                  ...
                                  mailtoCustomerAfterAcceptance(user,fl4[index].addname,fl4[index].username+'@gmail.com');
                                },
                                press2: (){
                                  _apply.child(fl4[index].key).update({
                                    'Confirm':'F',
                                  ...
                                  mailtoCustomerAfterRejection(user, fl4[index].addname, fl4[index].username+'@gmail.com');
                                },
                              );
