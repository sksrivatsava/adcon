    ...
    return MaterialApp(
      ...
      child: Scaffold(
          appBar: AppBar(
            ...
            toolbarHeight: 150,
            elevation: 0,
            title: Text('Ad Application Portal',
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return new TabCard(
                            line1: finstl[index].username,
                            line2: finstl[index].rate1.toString(),
                            press1: () {Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) =>
                              ...
                              press2: (){Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          Social(false,finstl[index].username)));}
                          );
                        }),
                  ],
                ),
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return new TabCard(
                            line1: fyoutubel[index].username,
                            ...
                            press2: (){Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        Social(true,fyoutubel[index].username)));}
                          );
                        }),
                  ],
                ),
                ...
                child: Column(
                  children: [
                    ...
                    ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return new TabCardNews(
                            line1: fnewsl[index].username,
  ...
  void selectedItem(BuildContext context, int index) {
    switch (index) {
      ...
      case 3:
        ...
        break;
      case 4:
        Navigator.push(context,MaterialPageRoute(builder: (context)=>AboutAdconsPage()));
        break;
    }
  }
}
...
class TabCard extends StatelessWidget {
  ...
  const TabCard({Key key, this.line1, this.line2, this.press1, this.press2})
      : super(key: key);
...
class TabCardNews extends StatelessWidget {
  final String line1;
  final String line2;

  final Function press;

  const TabCardNews({Key key, this.line1, this.line2, this.press})
      : super(key: key);
