 ...
 var link="";
  Widget build(BuildContext c) {
    ...
    _applyy.child(widget.ads.key+"@"+widget.adv).update({
                ...
                mailtoAdvertiserAfterSubmission(widget.ads.uid, widget.ads.aid, widget.adv+'@gmail.com', link);
                Navigator.pop(context,"back");
            },
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        "Please submit your draft link to ${widget.adv}, in order to to complete your ad application with them.",
