// import 'package:adcon/content.dart';
// import 'package:adcon/useradd.dart';
// import 'package:firebase_database/firebase_database.dart';
// import 'package:flutter/cupertino.dart';
// import 'package:flutter/material.dart';
//
// class contentsubmitted extends StatefulWidget {
//   final adv ads;
//   contentsubmitted(this.ads);
//   @override
//   _contentsubmittedState createState() => _contentsubmittedState();
// }
//
// class _contentsubmittedState extends State<contentsubmitted> {
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('confirmedadv for ${widget.ads.aid}'),
//       ),
...
//                       .isNotEmpty ? l2[index] : 'loading..'} link ${l[index].link}' ),
//               onTap: (){
//                 // Navigator.push(context, MaterialPageRoute(builder: (context)=>content(widget.ads, l[index].advertiserid)));
//
//               },
//             );
//           }
...
class contentsubmitted extends StatefulWidget {
  ...
  contentsubmitted(this.ads);
  @override
  _contentsubmittedState createState() => new _contentsubmittedState();
}
...
class TabCard extends StatelessWidget {
  ...
  const TabCard({Key key, this.line1, this.line2,this.line3, this.press})
      : super(key: key);
